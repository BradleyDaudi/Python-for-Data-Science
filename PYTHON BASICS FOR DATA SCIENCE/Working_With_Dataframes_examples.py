   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "C:\\Users\\USER\\AppData\\Local\\Temp\\ipykernel_5844\\3842239110.py:2: DtypeWarning: Columns (14,26) have mixed types. Specify dtype option on import or set low_memory=False.\n",
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "J. Hove        16       Norway       51       57         57      58       \n",
       "Javi Vázquez   16        Spain       58       61         53      48       \n",
       "K. Pierie      16  Netherlands       65       72         64      66       \n",
       "L. Pintor      16       France       54       72         29      70       \n",
       "\n",
       "             Balance Ball control Composure Crossing  ... Short passing  \\\n",
       "Name                                                  ...                 \n",
       "J. Romero     86           55        59       46      ...        52       \n",
       "J. Hove       56           51        42       40      ...        56       \n",
       "Javi Vázquez  65           47        43       33      ...        41       \n",
       "K. Pierie     53           65        66       47      ...        68       \n",
       "L. Pintor     68           56        43       27      ...        30       \n",
       "\n",
       "             Shot power Sliding tackle Sprint speed Stamina Standing tackle  \\\n",
       "Name                                                                          \n",
       "J. Romero        54             25           77      58              26       \n",
       "J. Hove          50             56           64      47              51       \n",
       "Javi Vázquez     42             59           64      59              63       \n",
       "K. Pierie        35             62           72      45              67       \n",
       "L. Pintor        57             12           68      36              10       \n",
       "\n",
       ...
       "K. Pierie      65      56      32                  LB CB   \n",
       "L. Pintor      34      38      48                     ST   \n",
       "\n",
       "[5 rows x 38 columns]"
      ]
     },
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       "               Age Nationality  Overall Acceleration Aggression Agility  \\\n",
       "Name                                                                      \n",
       "B. Richardson   47     England       46       25         44      35       \n",
       "E. El Hadary    44       Egypt       70       28         29      21       \n",
       "O. Pérez        44      Mexico       71       60         26      69       \n",
       "J. Walker       43     England       55       22         41      53       \n",
       "D. Coyne        43       Wales       55       36         36      48       \n",
       "\n",
       "              Balance Ball control Composure Crossing  ... Short passing  \\\n",
       "Name                                                   ...                 \n",
       "B. Richardson  44           22        44       11      ...        12       \n",
       "E. El Hadary   41           25        57       20      ...        16       \n",
       "O. Pérez       69           23        50       19      ...        26       \n",
       "J. Walker      64           38        35       16      ...        22       \n",
       "D. Coyne       58           31        57       13      ...        28       \n",
       "\n",
       "              Shot power Sliding tackle Sprint speed Stamina Standing tackle  \\\n",
       "Name                                                                           \n",
       "B. Richardson     13             13           25      32              12       \n",
       "E. El Hadary      18             15           39      34              19       \n",
       "O. Pérez          24             11           57      41              12       \n",
       "J. Walker         22             13           35      19              11       \n",
       "D. Coyne          21             19           33      37              16       \n",
       "\n",
       "              Strength  Vision Volleys Preferred Positions  \n",
       "Name                                                        \n",
       "B. Richardson   47      17      12                     GK   \n",
       "E. El Hadary    73      16      12                     GK   \n",
       "O. Pérez        66      40      13                     GK   \n",
       "J. Walker       62      32      11                     GK   \n",
       "D. Coyne        76      33      11                     GK   \n",
       "\n",
       "[5 rows x 38 columns]"
      ]
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "L. Modrić           31     Croatia       89       75         62      93       \n",
       "G. Chiellini        32       Italy       89       68         92      59       \n",
       "...                ...         ...      ...          ...        ...     ...   \n",
       "P. Jennings         37     England       52       38         40      54       \n",
       "K. Tokushige        33       Japan       51       25         18      38       \n",
       "H. Tanaka           34       Japan       49       41         92      58       \n",
       "Y. Uchimura         32       Japan       48       40         31      33       \n",
       "B. Richardson       47     England       46       25         44      35       \n",
       "\n",
       "                  Balance Ball control Composure Crossing  ... Short passing  \\\n",
       "Name                                                       ...                 \n",
       ...
       "L. Modrić          94           92        84       78      ...        92       \n",
       "G. Chiellini       64           57        82       58      ...        59       \n",
       "...                   ...          ...       ...      ...  ...           ...   \n",
       "P. Jennings        50           22        46       18      ...        35       \n",
       "K. Tokushige       39           12        41       12      ...        31       \n",
       "H. Tanaka          78           42        47       44      ...        57       \n",
       "Y. Uchimura        65           57        62       51      ...        60       \n",
       "B. Richardson      44           22        44       11      ...        12       \n",
       "\n",
       "                  Shot power Sliding tackle Sprint speed Stamina  \\\n",
       "Name                                                               \n",
       "Cristiano Ronaldo     94             23           91      92       \n",
       "M. Neuer              25             11           61      44       \n",
       "Sergio Ramos          79             91           77      84       \n",
       "L. Modrić             73             73           71      82       \n",
       "G. Chiellini          78             90           78      68       \n",
       "...                      ...            ...          ...     ...   \n",
       "P. Jennings           24             12           38      37       \n",
       "K. Tokushige          20             12           20      23       \n",
       "H. Tanaka             48             49           55      76       \n",
       "Y. Uchimura           40             42           39      29       \n",
       "B. Richardson         13             13           25      32       \n",
       "\n",
       "                  Standing tackle Strength  Vision Volleys Preferred Positions  \n",
       "Name                                                                            \n",
       "Cristiano Ronaldo          31       80      85      88                  ST LW   \n",
       "M. Neuer                   10       83      70      11                     GK   \n",
       "Sergio Ramos               89       81      63      66                     CB   \n",
       "L. Modrić                  80       58      90      74                 CDM CM   \n",
       "G. Chiellini               92       91      50      45                     CB   \n",
       "...                           ...      ...     ...     ...                 ...  \n",
       "P. Jennings                13       43      21      14                     GK   \n",
       "K. Tokushige               13       62      33       5                     GK   \n",
       "H. Tanaka                  41       56      42      35                 CDM CM   \n",
       "Y. Uchimura                42       37      47      38                    CAM   \n",
       "B. Richardson              12       47      17      12                     GK   \n",
       "\n",
       "[2534 rows x 38 columns]"
      ]
     },
     "execution_count": 6,
     "metadata": {},
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       "                   Overall\n",
       "Age Nationality           \n",
       "16  Argentina    56.000000\n",
       "    England      61.500000\n",
       "    France       54.000000\n",
       "    Germany      57.000000\n",
       "    Italy        61.000000\n",
       "    Netherlands  62.000000\n",
       "    Norway       54.500000\n",
       "    Romania      54.000000\n",
       "    Spain        58.000000\n",
       "17  Algeria      54.000000\n",
       "    Argentina    57.333333\n",
       "    Australia    52.000000\n",
       "    Austria      54.500000\n",
       "    Belgium      58.250000\n",
   ...
   "outputs": [
    {
     ...
     "traceback": [
      ...
      "Cell \u001b[1;32mIn[27], line 2\u001b[0m\n\u001b[0;32m      1\u001b[0m \u001b[38;5;66;03m# Use the map() function to transform all selected columns.\u001b[39;00m\n\u001b[1;32m----> 2\u001b[0m df[cols] \u001b[38;5;241m=\u001b[39m \u001b[43mdf\u001b[49m\u001b[43m[\u001b[49m\u001b[43mcols\u001b[49m\u001b[43m]\u001b[49m\u001b[38;5;241;43m.\u001b[39;49m\u001b[43mmap\u001b[49m(to_float)\n",
